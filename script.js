...
function makeGuess(){
   ...
   if(guess == answer){
       ...
       if (range == 10){
           if (guessCount < 3){
                msg.textContent = "Amazing work! Correct! It took " + guessCount + " tries, " + casedName + "!";
           }
           else if (guessCount < 5){
               msg.textContent = "Good job! Correct! It took " + guessCount + " tries, " + casedName + "!";
           }
           else {
               msg.textContent = "Nice try! Correct! It took " + guessCount + " tries, " + casedName + "!";
           }
       }
       else if (range == 100){
           if (guessCount < 8){
